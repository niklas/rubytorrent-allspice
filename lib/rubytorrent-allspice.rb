...
## rubytorrent-allspice.rb -- top-level RubyTorrent file.
...
require 'rubytorrent-allspice/util'
require 'rubytorrent-allspice/bencoding'
require 'rubytorrent-allspice/metainfo'
