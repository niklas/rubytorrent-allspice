...
require "rubytorrent-allspice/controller"
require "rubytorrent-allspice/peer"
...
#    rt_debug "their info hash: #{their_hash.inspect}"
    their_hash = their_hash.each_byte.collect{|b| b.chr}.join()
    # puts "their_hash: #{their_hash.each_byte.collect{|b| b}}"
